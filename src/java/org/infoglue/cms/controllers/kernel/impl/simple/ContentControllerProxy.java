...
public class ContentControllerProxy extends ContentController 
{
    ...
    public ContentVO getACContentVOWithId(InfoGluePrincipal infogluePrincipal, Integer contentId, Database db) throws Exception
    {
    ...
    public ContentVO getACContentVOWithId(InfoGluePrincipal infogluePrincipal, Integer contentId) throws Exception
    {
    	Map hashMap = new HashMap();
    	hashMap.put("contentId", contentId);
    ...
    public List getACContentVOList(InfoGluePrincipal infoGluePrincipal, HashMap argumentHashMap, Database db) throws Exception
    {
	...
	public ContentVO acCreate(InfoGluePrincipal infogluePrincipal, CreateContentWizardInfoBean createContentWizardInfoBean) throws ConstraintException, SystemException
	{
	...
	public ContentVO acCreate(InfoGluePrincipal infogluePrincipal, Integer parentContentId, Integer contentTypeDefinitionId, Integer repositoryId, ContentVO contentVO) throws Exception
	{
		Map hashMap = new HashMap();
	...
	public ContentVO acUpdate(InfoGluePrincipal infogluePrincipal, ContentVO contentVO, Integer contentTypeDefinitionId) throws Exception
	{
		Map hashMap = new HashMap();
	...
	public void acDelete(InfoGluePrincipal infogluePrincipal, ContentVO contentVO) throws Exception
	{
		Map hashMap = new HashMap();
		hashMap.put("contentId", contentVO.getId());
	...
	public void acMarkForDelete(InfoGluePrincipal infogluePrincipal, ContentVO contentVO) throws Exception
	{
		Map hashMap = new HashMap();
		hashMap.put("contentId", contentVO.getId());
	...
	public void acMoveContent(InfoGluePrincipal infogluePrincipal, ContentVO contentVO, Integer newParentContentId) throws Exception
	{
		Map hashMap = new HashMap();
		hashMap.put("contentId", contentVO.getId());
	...
	public void acMoveContent(InfoGluePrincipal infogluePrincipal, ContentVO contentVO, Integer newParentContentId, Database db) throws Exception
	{
		Map hashMap = new HashMap();
		hashMap.put("contentId", contentVO.getId());
