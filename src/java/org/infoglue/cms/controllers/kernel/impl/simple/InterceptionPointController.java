...
public class InterceptionPointController extends BaseController
{
	...
	static
	{
	    ...
	    systemInterceptionPoints.put("Repository.UpdateProperties", new InterceptionPointVO("Repository", "Repository.UpdateProperties", "Triggered by the update action when updating repository properties", true));
