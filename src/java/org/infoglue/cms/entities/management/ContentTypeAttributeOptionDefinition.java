...
public class ContentTypeAttributeOptionDefinition implements GenericOptionDefinition
{    
    private String name;
    private String value;
    
    public ContentTypeAttributeOptionDefinition(String name, String value)
    {
        this.name 						= name;
        this.value 						= value;
    }
