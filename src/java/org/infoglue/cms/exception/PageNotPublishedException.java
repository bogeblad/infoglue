...
/**
 * <p>Thrown to indicate that a page has no published versions</p>
 *
 * @author <a href="mailto:bogeblad@yahoo.com">Mattias Bogeblad</a>
 */
public class PageNotPublishedException extends SystemException
{
	/**
	 * Construct a SystemException with the detailed error message.
	 * @param message the detailed error message.
	 */
	public PageNotPublishedException(String message)
	{
		super(message);
	}
	 ...
	 */
	public PageNotPublishedException(Throwable cause)
	{
		super(cause);
	}
	 ...
	 */
	public PageNotPublishedException(String message, Throwable cause)
	{
		super(message, cause);
	}
}