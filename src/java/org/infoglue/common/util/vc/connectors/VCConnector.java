...
package org.infoglue.common.util.vc.connectors;

import java.io.File;
import java.util.List;

/**
 * Interface for all version control connector classes
 * 
 * @author Mattias Bogeblad
 *
 */

public interface VCConnector
{
	public void checkOutModuleFromHead(String aModuleName) throws Exception;
		
	public List<File> checkOutModuleFromTag(String moduleName, String tagName) throws Exception;
	
	public void updateFilesFromHead(File[] aFiles) throws Exception;
