...
public class ContentTypeDefinitionCategoriesTag extends TemplateControllerTag 
{
	...
	public ContentTypeDefinitionCategoriesTag()
    {
        super();
    }
    ...
    {
	    //if(languageId != null)
	        setResultAttribute(getController().getContentTypeDefinitionCategories(this.schemaValue));
	    /*
