...
function sortSelect(obj)
{
	...
	{
		var option = new Option( obj.options[i].text, obj.options[i].value, obj.options[i].defaultSelected, obj.options[i].selected) ;
		option.disabled = obj.options[i].disabled;
		o[o.length] = option;
	}
	if(o.length==0)
	{
	...
	{
		var option = new Option(o[i].text, o[i].value, o[i].defaultSelected, o[i].selected);
		option.disabled = obj.options[i].disabled;
