			...
			init: function (opt) {
				...
				return this.each(function () {
					if (!$(this).data('colorpickerId')) {
						...
						options.selector = cal.find('div.colorpicker_color').bind('mousedown', downSelector).bind('mouseup', upSelector);;
						//options.selector = cal.find('div.colorpicker_color').bind('click', downSelector);
